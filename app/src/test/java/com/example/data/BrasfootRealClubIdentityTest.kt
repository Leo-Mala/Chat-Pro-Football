...
class BrasfootRealClubIdentityTest {
    ...
    fun rejectsSlotOrCrestReuse() {
        val duplicateSlot = listOf(
            BrasfootRealClubIdentity.Replacement("Brasil", 2, "Slot A", "Real A", "a.png"),
            BrasfootRealClubIdentity.Replacement("Brasil", 2, "Slot A", "Real B", "b.png")
        )
        ...
        val duplicateCrest = listOf(
            BrasfootRealClubIdentity.Replacement("Brasil", 2, "Slot A", "Real A", "same.png"),
            BrasfootRealClubIdentity.Replacement("Brasil", 2, "Slot B", "Real B", "SAME.PNG")
        )
        assertThrows(IllegalArgumentException::class.java) {
