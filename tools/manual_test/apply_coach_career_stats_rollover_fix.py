...
season_transition = ROOT / "app/src/main/java/com/example/usecase/SeasonTransitionUseCase.kt"
replace_exact(
    season_transition,
...
write_text(ROOT / "app/src/test/java/com/example/usecase/CoachCareerStatsSeasonTransitionRegressionTest.kt", '''package com.example.usecase
...
print("coach career rollover stats fix prepared")
